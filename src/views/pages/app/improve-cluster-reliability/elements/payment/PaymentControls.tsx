      ...
      <div className="grid grid-cols-2 !gap-4 3xl:!gap-5">
        {props.prices &&
          props.prices[priceType][props.preferredCurrency][productType].map((price: Price, index) => (
            <button
              ...
              } text-white !px-3 flex justify-center min-h-16 duration-100 ease-linear transition-all flex-col sm:min-h-[69px] 3xl:min-h-[81px] items-center 3xl:!px-4 rounded-[13px]`}
        ...
        {config.env !== Env.Production && (
          <button
            ...
            } w-full min-h-16 sm:min-h-[69px] 3xl:min-h-[81px]  bg-[#16263B] border-[#D8D8D8]  border rounded-xl flex items-center px-6`}
          >
